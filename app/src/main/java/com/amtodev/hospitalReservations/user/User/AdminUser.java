package com.amtodev.hospitalReservations.user.User;
...
public class AdminUser extends AppCompatActivity {
    ...
    public void openDialog(View view){
        AlertDialog.Builder builder = new AlertDialog.Builder(AdminUser.this);
        ...
        builder.setNegativeButton("No", new DialogInterface.OnClickListener(){
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                Toast.makeText(AdminUser.this, "No Logout", Toast.LENGTH_SHORT).show();
            }
        });
        builder.create();
        builder.show();
